...
Meteor.methods({
    ...
    moveToNextSerie(id, actual_exercise_index, actual_serie_index, exercise ){
        ...
        if(routine.exercises[ actual_exercise_index ].status === 'going on'){
            ...
            if(routine.exercises[ actual_exercise_index ].series[ actual_serie_index + 1 ]){
                ...
                console.log(actual_exercise_index);
                if(routine.exercises[ actual_exercise_index ].status === 'going on'){
                    ...
                    console.log('El ejercicio no tiene el estado deseado'+actual_exercise.series[ actual_serie_index ].status);
                };
            }
        }else{
